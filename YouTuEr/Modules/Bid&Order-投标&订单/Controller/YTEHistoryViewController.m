...
@interface YTEHistoryViewController ()
...
@implementation YTEHistoryViewController
...
- (void)viewDidLoad {
    ...
    [self config];
    [self omerchartMyBidHistoryRequest];
}
...
- (void)omerchartMyBidHistoryRequest {
    ...
    @weakify(self);
    [[SROrderService sharedService] omerchartMyBidHistoryRequestWithModel:self.serviceModel successBlock:^(NSDictionary *returnData, NSURLSessionTask *task) {
        @strongify(self);
        [self stopLoading];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if(tableView == self.leftTableView) {
        ...
        cell.orderStatus = YTEOrderStatusHistory;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == self.leftTableView) {
        ...
        [YTEOrderDetailView detailtView:[self arrayBySeletedIndex:self.selectIndex][indexPath.section] orderStatus:YTEOrderStatusHistory];
    }
}
