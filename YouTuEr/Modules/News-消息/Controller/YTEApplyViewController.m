...
#import "YTEApplyFriendCell.h"
#import "InvitationManager.h"

static YTEApplyViewController *controller = nil;

@interface YTEApplyViewController ()<ApplyFriendCellDelegate>

@end

@implementation YTEApplyViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YTEApplyFriendCell *cell = (YTEApplyFriendCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    // Configure the cell...
    if (cell == nil) {
        cell = [[YTEApplyFriendCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
        cell.delegate = self;
...
{
    ApplyEntity *entity = [self.dataSource objectAtIndex:indexPath.row];
    return [YTEApplyFriendCell heightWithContent:entity.reason];
}
