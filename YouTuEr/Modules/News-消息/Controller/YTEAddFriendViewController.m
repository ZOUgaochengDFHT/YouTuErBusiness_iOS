...
#import "YTEAddFriendCell.h"
#import "InvitationManager.h"
#import "EMAlertView.h"

@interface YTEAddFriendViewController ()<UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIAlertViewDelegate>
...
@implementation YTEAddFriendViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YTEAddFriendCell *cell = (YTEAddFriendCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    // Configure the cell...
    if (cell == nil) {
        cell = [[YTEAddFriendCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
    
    cell.imageView.image = SR_IMGName(@"chatListCellHead");
...
#warning Test code, by default, the user system has a user with the same name.
        ...
        //判断是否已发来申请
        NSArray *applyArray = [[YTEApplyViewController shareController] dataSource];
