...
NSString *const kSAMKeychainServiceDomain = @"com.yoututour.yochtec";
NSString *const kSAMKeychainNickNameKey = @"com.yoututour.yochtec.nickName";
NSString *const kSAMKeychainClientIdKey = @"com.yoututour.yochtec.clientId";
NSString *const kSAMKeychainU = @"com.samsoffes.samkeychain";
...
+ (NSString *)nickName {
    NSString *result = [self passwordForService:kSAMKeychainServiceDomain account:kSAMKeychainNickNameKey];
    return result;
}

+ (BOOL)setNickName:(NSString *)nickName {
    if (nickName) {
        return [self setPassword:nickName forService:kSAMKeychainServiceDomain account:kSAMKeychainNickNameKey];
    }
    
    return [self deletePasswordForService:kSAMKeychainServiceDomain account:kSAMKeychainNickNameKey];
}


+ (NSString *)clientId {
    NSString *result = [self passwordForService:kSAMKeychainServiceDomain account:kSAMKeychainClientIdKey];
    return result;
}

+ (BOOL)setClientId:(NSString *)clientId {
    if (clientId) {
        return [self setPassword:clientId forService:kSAMKeychainServiceDomain account:kSAMKeychainClientIdKey];
    }
    
    return [self deletePasswordForService:kSAMKeychainServiceDomain account:kSAMKeychainClientIdKey];
}
