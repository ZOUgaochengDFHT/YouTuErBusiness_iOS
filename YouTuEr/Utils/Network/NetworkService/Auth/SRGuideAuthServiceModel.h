...
/**
 请求url：${curServerUrl}/m/authen/cicerone
 请求方式： POST
 参数:
 {
 "member_id": 1, /商家ID
 "working_years": 3,//从业时间
 "cicerone_type":"国内",//导游类型
...
@interface SRGuideAuthServiceModel : SRRequestModel

@property (assign, nonatomic) NSInteger member_id;
@property (copy, nonatomic) NSString *working_years;
@property (copy, nonatomic) NSString *cicerone_type;
